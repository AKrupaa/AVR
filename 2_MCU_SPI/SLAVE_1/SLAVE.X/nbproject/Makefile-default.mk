...
SOURCEFILES_QUOTED_IF_SPACED=LM35.c SPI_slave.c SPI_utilities.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LM35.o ${OBJECTDIR}/SPI_slave.o ${OBJECTDIR}/SPI_utilities.o
POSSIBLE_DEPFILES=${OBJECTDIR}/LM35.o.d ${OBJECTDIR}/SPI_slave.o.d ${OBJECTDIR}/SPI_utilities.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LM35.o ${OBJECTDIR}/SPI_slave.o ${OBJECTDIR}/SPI_utilities.o

# Source Files
SOURCEFILES=LM35.c SPI_slave.c SPI_utilities.c
...
${OBJECTDIR}/SPI_slave.o: SPI_slave.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/SPI_slave.o.d 
	@${RM} ${OBJECTDIR}/SPI_slave.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG  -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp=${DFP_DIR}  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -Wall -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3     -MD -MP -MF "${OBJECTDIR}/SPI_slave.o.d" -MT "${OBJECTDIR}/SPI_slave.o.d" -MT ${OBJECTDIR}/SPI_slave.o -o ${OBJECTDIR}/SPI_slave.o SPI_slave.c 
